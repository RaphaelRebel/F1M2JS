...
function finishQuiz() {
  ...
  if (playerData.goodAnswers == 1){
    foto = "../F1M2BO-Quiz-Javascript/photos/1-goed.jpg"
  }
  if (playerData.goodAnswers == 2){
    foto = "../F1M2BO-Quiz-Javascript/photos/2-goed.jpg"
  }
  if (playerData.goodAnswers == 3){
    foto = "../F1M2BO-Quiz-Javascript/photos/3-goed.jpg"
  }
  if (playerData.goodAnswers == 4){
    foto = "../F1M2BO-Quiz-Javascript/photos/4-goed.jpg"
  }
  if (playerData.goodAnswers == 5){
    foto = "../F1M2BO-Quiz-Javascript/photos/5-goed.jpg"
  }
  if (playerData.goodAnswers == 6){
    foto = "../F1M2BO-Quiz-Javascript/photos/6-goed.jpg"
  }
  resultBox.innerHTML = "<h2>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</h2></br></br><h1>Jij bent:</h1> </br> <img src="+foto+" />";
  console.log(playerData.goodAnswers);

  //als de antwoorden maar 1 goed hebben, laat foto 1 zien
