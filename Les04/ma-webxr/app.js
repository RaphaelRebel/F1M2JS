...
cubeRoom.setPosition(0, 1.54, -5);
cubeRoom.setScale(0.6, 0.6, 0.6);
...
const folkerDeJong = new XRImage('assets/images/FolkertdeJong.jpg');
folkerDeJong.setPosition(-2.48819, 3.45839, -2);
